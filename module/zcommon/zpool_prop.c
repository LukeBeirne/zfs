...
zpool_prop_init(void)
{
	...
	zprop_register_string(ZPOOL_PROP_ZIA_PROVIDER, "zia_provider", NULL,
	    ...
	    sfeatures);
	zprop_register_string(ZPOOL_PROP_ZIA_COMPRESS, "zia_compress", NULL,
	    PROP_DEFAULT, ZFS_TYPE_POOL, "<Z.I.A. Provider Name>", "PROVIDER",
	    sfeatures);
	zprop_register_string(ZPOOL_PROP_ZIA_DECOMPRESS, "zia_decompress", NULL,
	    PROP_DEFAULT, ZFS_TYPE_POOL, "<Z.I.A. Provider Name>", "PROVIDER",
	    sfeatures);
	zprop_register_string(ZPOOL_PROP_ZIA_CHECKSUM, "zia_checksum", NULL,
	    PROP_DEFAULT, ZFS_TYPE_POOL, "<Z.I.A. Provider Name>", "PROVIDER",
	    sfeatures);
	...
	zprop_register_string(ZPOOL_PROP_ZIA_RAIDZ2_GEN, "zia_raidz2_gen", NULL,
	    PROP_DEFAULT, ZFS_TYPE_POOL, "<Z.I.A. Provider Name>", "PROVIDER",
	    sfeatures);
	zprop_register_string(ZPOOL_PROP_ZIA_RAIDZ3_GEN, "zia_raidz3_gen", NULL,
	    PROP_DEFAULT, ZFS_TYPE_POOL, "<Z.I.A. Provider Name>", "PROVIDER",
	    sfeatures);
	zprop_register_string(ZPOOL_PROP_ZIA_RAIDZ1_REC, "zia_raidz1_rec", NULL,
	    PROP_DEFAULT, ZFS_TYPE_POOL, "<Z.I.A. Provider Name>", "PROVIDER",
	    sfeatures);
	zprop_register_string(ZPOOL_PROP_ZIA_RAIDZ2_REC, "zia_raidz2_rec", NULL,
	    PROP_DEFAULT, ZFS_TYPE_POOL, "<Z.I.A. Provider Name>", "PROVIDER",
	    sfeatures);
	zprop_register_string(ZPOOL_PROP_ZIA_RAIDZ3_REC, "zia_raidz3_rec", NULL,
	    PROP_DEFAULT, ZFS_TYPE_POOL, "<Z.I.A. Provider Name>", "PROVIDER",
	    sfeatures);
	zprop_register_string(ZPOOL_PROP_ZIA_FILE_WRITE, "zia_file_write", NULL,
	    PROP_DEFAULT, ZFS_TYPE_POOL, "<Z.I.A. Provider Name>", "PROVIDER",
	    sfeatures);
	zprop_register_string(ZPOOL_PROP_ZIA_DISK_WRITE, "zia_disk_write", NULL,
	    PROP_DEFAULT, ZFS_TYPE_POOL, "<Z.I.A. Provider Name>", "PROVIDER",
	    sfeatures);
